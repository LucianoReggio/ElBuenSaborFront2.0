    ...
    <CarritoProvider>
      <Router>
        <Routes>
          ...
          <Route path="/productos/:id" element={<PublicLayout><ProductoDetalle /></PublicLayout>} />
          <Route path="/registro" element={<PublicLayout><RegistroPage /></PublicLayout>} />
          <Route path="/login" element={<PublicLayout><LoginPage /></PublicLayout>} />
          <Route path="/mis-pedidos" element={<PublicLayout><MisPedidos /></PublicLayout>} />
          ...
          <Route path="/productos" element={<AdminLayout><Productos /></AdminLayout>} />
          <Route path="/stock" element={<AdminLayout><StockControl /></AdminLayout>} />
          ...
          <Route path="*" element={
            <PublicLayout>
              <div className="bg-white p-8 rounded-lg shadow-sm text-center border border-[#99AAB3] border-opacity-20 m-8">
                <h2 className="text-2xl font-bold text-[#CD6C50] mb-4">Página no encontrada</h2>
                <p className="text-[#99AAB3] mb-6">La página que buscas no existe.</p>
                <Link
                  to="/"
