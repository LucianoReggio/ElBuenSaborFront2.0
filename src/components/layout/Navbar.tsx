    ...
    <nav className="bg-white shadow-sm border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          {/* Izquierda: Botones de Autenticación o Menú de Usuario */}
          ...
          {/* Centro: Logo - Clickeable que lleva al Home */}
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden border-t border-gray-200 bg-white py-4">
            ...
            {/* Botones de autenticación en móvil - Solo para usuarios no autenticados */}
            {!isAuthenticated && (
            ...
            {/* Menú de usuario autenticado en móvil */}
