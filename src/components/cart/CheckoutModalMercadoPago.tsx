...
const CheckoutModalMercadoPago: React.FC<CheckoutModalMercadoPagoProps> = ({
  ...
  const { user, isAuthenticated, backendUser } = useAuth();
  ...
  useEffect(() => {
    ...
    if (backendUser) {
      ...
      console.log(
        "🔍 Todas las propiedades de backendUser:",
  ...
  const cargarDomicilios = async () => {
    try {
      ...
      console.log(
        "✅ Domicilios cargados:",
        clienteData.domicilios?.length || 0
      );
      ...
      if (user?.domicilios) {
        ...
        console.log(
          "🔄 Usando domicilios del user cache:",
  ...
  const crearPedidoEfectivo = async () => {
    ...
    if (!clienteId) {
      console.log(
        "⚠️ Obteniendo idCliente del backend para pedido efectivo..."
      );
      try {
        const perfilCompleto = await ClienteService.getMyProfile();
        clienteId = perfilCompleto.idCliente;
    ...
    console.log(
      "💵 Creando pedido con pago en efectivo (CON PROMOCIONES):",
      pedidoRequest
    );
  ...
  const crearPedidoMercadoPago = async () => {
    ...
    console.log(
      ...
      typeof pedidoRequest.idCliente
    );
    console.log(
      "  - tipoEnvio:",
      pedidoRequest.tipoEnvio,
      typeof pedidoRequest.tipoEnvio
    );
    console.log(
      "  - idSucursal:",
      pedidoRequest.idSucursal,
      typeof pedidoRequest.idSucursal
    );
    console.log(
      "  - emailComprador:",
      pedidoRequest.emailComprador,
      typeof pedidoRequest.emailComprador
    );
    console.log(
      "  - nombreComprador:",
      pedidoRequest.nombreComprador,
      typeof pedidoRequest.nombreComprador
    );
    console.log(
      "  - apellidoComprador:",
      pedidoRequest.apellidoComprador,
      typeof pedidoRequest.apellidoComprador
    );
